...
"""Contains logic and data types for extracting info about the current system."""
...
def get_os_version() -> Optional[Version]:
    ...
    .. note:: We discover the operating system's current version through delgated calls
        ...
        :func:`~semantic_version.Version.coerce` to build a *usable* version data type.
...
@dataclass
class UserContext:
    """Contains the context properties of the current system user."""
...
@dataclass
class SystemContext:
    """Contains the context properties of the current system."""
