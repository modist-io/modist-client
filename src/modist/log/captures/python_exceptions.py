...
"""Contains logging captures specific to Loguru for uncaught exception events.

This module provides the necessary functison to enable capturing of all raised Python
exceptions as :func:`logging.error` messages. This typically is used as a countermeasure
to accidentially missing a large portion of uncaught excetions due to lack of sufficient
logging in your project. It should really only be used as a temporary measure, but I've
seen plently of projects do fine by just enabling global exception logging.

    If you instead use the provided :func:`~modist.log.configure_logger` function, you
    will have an easier time setting up the global logger's exception capture.

An example of what this module can achieve is show below:
...
>>> python_exceptions.capture(log)
>>> raise ValueError("Something bad")
2020-05-21 17:20:13.746 | ERROR    | modist.log.captures.python_exceptions:_excepthook:\
40 - Something bad
NoneType: None
Traceback (most recent call last):
  File "<stdin>", line 1, in <module>
