...
make our logs _worth the effort_.
...
:func:`loguru._logger.Logger.bind` method...
...
:func:`loguru._logger.Logger.catch` method (just be sure to stay Pythonic and always
...
from .client import configure_logger, get_logger, instance

__all__ = ["get_logger", "configure_logger", "instance"]
